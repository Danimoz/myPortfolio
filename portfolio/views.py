...
from .serializers import ProjectSerializer, BlogSerializer, SkillSerializer, ContactSerializer, MailingListSerializer
...
class ContactView(APIView):
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            send_mail(
                'Hi Daniel!, Someone wants to reach out to you',
                message,
        ...
        return Response(
            {'data': serializer.errors, 'message': 'Something went wrong, Please try again later'},
